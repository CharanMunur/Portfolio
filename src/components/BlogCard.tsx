...
const BlogCard = ({ title, description, tags, date, readTime }: Blog) => {
  return (
    ...
    >
      <div className="flex flex-col gap-3 bg-card border border-dashed border-border/80 p-4 sm:p-5 rounded-xl w-full overflow-hidden hover:bg-muted/20 transition-all duration-200 cursor-pointer">
